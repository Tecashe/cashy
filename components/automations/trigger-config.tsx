...
//             {/* Story Reply Trigger Configuration */}
//             {trigger.type === "story_reply" && (
//               <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
//                 <div className="space-y-3 rounded-lg border border-border/50 bg-muted/30 p-4">
//                   <Label className="text-base font-semibold">Listen for</Label>
...
//                   >
//                     <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                       <RadioGroupItem value="any" id="any-story-reply" />
//                       <Label htmlFor="any-story-reply" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">Any reply</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">Triggers on every story reply received</p>
//                       </Label>
//                     </div>
//                     <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                       <RadioGroupItem value="keywords" id="keywords-story-reply" />
//                       <Label htmlFor="keywords-story-reply" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">Specific keywords</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">
//                           Only triggers when reply contains specific keywords
//                         </p>
//                       </Label>
//                     </div>
//                     <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                       <RadioGroupItem value="first_time" id="first-time-story-reply" />
//                       <Label htmlFor="first-time-story-reply" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">First-time replier</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">
//                           Only triggers for users replying for the first time
//                         </p>
//                       </Label>
//                     </div>
//                     <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                       <RadioGroupItem value="question" id="question-story-reply" />
//                       <Label htmlFor="question-story-reply" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">Questions only</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">
//                           Triggers when reply contains a question mark
//                         </p>
//                       </Label>
//                     </div>
//                   </RadioGroup>
...
//                         >
//                           <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                             <RadioGroupItem value="any" id="any-story-keyword" />
//                             <Label htmlFor="any-story-keyword" className="flex-1 cursor-pointer font-normal">
//                               <span className="font-medium">Contains any keyword</span>
//                               <p className="text-xs text-muted-foreground mt-0.5">
//                                 Triggers when at least one keyword is found
//                               </p>
...
//                           </div>
//                           <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                             <RadioGroupItem value="all" id="all-story-keywords" />
//                             <Label htmlFor="all-story-keywords" className="flex-1 cursor-pointer font-normal">
//                               <span className="font-medium">Contains all keywords</span>
//                               <p className="text-xs text-muted-foreground mt-0.5">
//                                 Triggers only when all keywords are found
//                               </p>
...
//                           </div>
//                           <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                             <RadioGroupItem value="exact" id="exact-story-keyword" />
//                             <Label htmlFor="exact-story-keyword" className="flex-1 cursor-pointer font-normal">
//                               <span className="font-medium">Exact match</span>
//                               <p className="text-xs text-muted-foreground mt-0.5">
//                                 Triggers only for exact phrase match
//                               </p>
...
//                         <span className="font-medium">All stories</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">
//                           Apply automation to all current and future stories
//                         </p>
//                       </Label>
//                     </div>
//                     <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                       <RadioGroupItem value="specific" id="specific-stories" />
//                       <Label htmlFor="specific-stories" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">Specific stories</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">Choose which stories to automate</p>
//                       </Label>
//                     </div>
//                   </RadioGroup>
...
//                             {selectedStoryIds.length} {selectedStoryIds.length === 1 ? "story" : "stories"} selected
//                           </span>
//                           <Button variant="outline" size="sm" onClick={() => setShowStorySelector(true)}>
//                             Change Selection
//                           </Button>
//                         </div>
//                       </motion.div>
...
//                     <Image src="/path/to/image.png" alt="Stories" className="h-5 w-5" width={20} height={20} />
//                     Which stories to automate?
//                   </Label>
//                   <RadioGroup
//                     value={selectedStoryIds.length > 0 ? "specific" : "all"}
//                     onValueChange={(value) => {
...
//                       <Label htmlFor="all-stories" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">All stories</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">Apply to all current and future stories</p>
//                       </Label>
//                     </div>
//                     <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
//                       <RadioGroupItem value="specific" id="specific-stories" />
//                       <Label htmlFor="specific-stories" className="flex-1 cursor-pointer font-normal">
//                         <span className="font-medium">Specific stories only</span>
//                         <p className="text-xs text-muted-foreground mt-0.5">Choose exact stories</p>
//                       </Label>
//                     </div>
//                   </RadioGroup>
...
//                       <p className="text-sm text-muted-foreground">{selectedStoryIds.length} stories selected</p>
//                       <Button
//                         type="button"
//                         variant="outline"
//                         size="sm"
...
// export function TriggerConfig({ open, onClose, trigger, onSave, accounts, selectedAccountId }: TriggerConfigProps) {
//   const [config, setConfig] = useState(trigger.config)
//   const [keywordInput, setKeywordInput] = useState("")
//   const [posts, setPosts] = useState<any[]>([])
//   const [isLoadingPosts, setIsLoadingPosts] = useState(false)
...
//   useEffect(() => {
//     if (trigger.type === "comment" && open && selectedAccountId) {
//       setIsLoadingPosts(true)
//       getInstagramPosts(selectedAccountId)
//         .then((media) => {
//           setPosts(media)
//         })
//         .catch((error) => {
...
//         })
//     }
//   }, [trigger.type, open, selectedAccountId])
...
//                 <AnimatePresence>
//                   {selectedPostIds.length > 0 && selectedAccountId && (
//                     <motion.div
//                       initial={{ opacity: 0, height: 0 }}
//                       animate={{ opacity: 1, height: "auto" }}
//                       exit={{ opacity: 0, height: 0 }}
...
//       {showPostSelector && selectedAccountId && (
//         <InstagramPostSelector
//           open={showPostSelector}
//           onOpenChange={setShowPostSelector}
//           accountId={selectedAccountId}
...
//       {showStorySelector && selectedAccountId && (
//         <InstagramStorySelector
//           open={showStorySelector}
//           onOpenChange={setShowStorySelector}
//           accountId={selectedAccountId}
...
import { motion, AnimatePresence } from "framer-motion"
import Image from "next/image"
import { KEYWORD_SOURCES } from "@/lib/constants/utomation-constants"
          ...
          <div className="space-y-6">
            ...
            {trigger.type === "keyword" && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                ...
                <div className="space-y-3 rounded-lg border border-border/50 bg-muted/30 p-4">
                  <Label className="text-base font-semibold">Trigger Source</Label>
                  <p className="text-xs text-muted-foreground -mt-1 mb-2">Where should we listen for these keywords?</p>
                  <RadioGroup
                    value={config.keywordSource || "both"}
                    onValueChange={(value) =>
                      setConfig({ ...config, keywordSource: value as "dm" | "comment" | "both" })
                    }
                  ...
                  >
                    {KEYWORD_SOURCES.map((source) => (
                      <div
                        key={source.value}
                        className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50"
                      >
                        <RadioGroupItem value={source.value} id={`source-${source.value}`} />
                        <Label htmlFor={`source-${source.value}`} className="flex-1 cursor-pointer font-normal text-sm">
                          {source.label}
                        </Label>
                      </div>
                    ))}
                ...
                {/* Specific post selection for comments if source is comment/both */}
                <AnimatePresence>
                  {(config.keywordSource === "comment" || config.keywordSource === "both") && (
                    <motion.div
                      initial={{ opacity: 0, height: 0 }}
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
                          <RadioGroupItem value="all" id="all-posts-kw" />
                          <Label htmlFor="all-posts-kw" className="flex-1 cursor-pointer font-normal">
                            <span className="font-medium">All posts</span>
                            <p className="text-xs text-muted-foreground mt-0.5">
                              Listen for keywords in comments of all posts
                            </p>
                          </Label>
                        </div>
                        <div className="flex items-center space-x-3 rounded-md border border-border/50 bg-background p-3 transition-colors hover:bg-accent/50">
                          <RadioGroupItem value="specific" id="specific-posts-kw" />
                          <Label htmlFor="specific-posts-kw" className="flex-1 cursor-pointer font-normal">
                            <span className="font-medium">Specific posts</span>
                            <p className="text-xs text-muted-foreground mt-0.5">
                              Only listen for keywords on selected posts
                            </p>
                          </Label>
                        </div>
                      </RadioGroup>
                      ...
                      {selectedPostIds.length > 0 && (
                        <div className="mt-4 pt-4 border-t border-border/50">
                          <div className="flex items-center justify-between mb-3">
                            <Label className="text-sm font-semibold">Selected Posts</Label>
