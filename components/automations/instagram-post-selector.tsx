...
//   const getMediaDisplayUrl = (post: Post) => {
//     // For videos, use thumbnail_url if available, otherwise use media_url
//     if (post.media_type === "VIDEO") {
//       return post.thumbnail_url || post.media_url || "/placeholder.svg?height=300&width=300"
//     }
//     return post.media_url || "/placeholder.svg?height=300&width=300"
//   }
...
//                       >
//                         <img
//                           src={getMediaDisplayUrl(post) || "/placeholder.svg"}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="absolute top-3 right-3">
                          {isSelected ? (
                            <div className="p-1.5 rounded-full bg-blue-500 shadow-lg animate-in zoom-in">
                              <CheckCircle2 className="w-5 h-5 text-white" />
                            </div>
                          ) : (
                            <div className="p-1.5 rounded-full bg-black/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        {post.media_type !== "IMAGE" && (
                          <Badge
                            variant="secondary"
                            className="absolute top-3 left-3 text-xs backdrop-blur-sm bg-black/60 text-white border-white/20 flex items-center gap-1.5 px-2 py-1"
                          >
                            {getMediaIcon(post.media_type)}
                            {post.media_type === "VIDEO" ? "Video" : "Carousel"}
                          </Badge>
