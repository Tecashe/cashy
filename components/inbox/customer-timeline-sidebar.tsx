        ...
        <div className="p-4 space-y-6">
          <Card className="p-4 bg-muted/20">
            <div className="flex flex-col items-center text-center">
              <Avatar className="h-20 w-20 mb-3 border-2 border-border">
                <AvatarImage
                  src={
                    ...
                    `https://avatar.vercel.sh/${conversation.participantUsername || "user"}`
                  }
              ...
              <h4 className="font-semibold">
                {conversation.participantName || conversation.participantUsername || "Unknown Customer"}
              </h4>
          ...
          {history && (
            <div className="grid grid-cols-2 gap-3">
              <Card className="p-3 text-center bg-muted/10">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {history.conversations.slice(1, 4).map((conv: any) => (
                    <Card key={conv.id} className="p-3 hover:bg-accent cursor-pointer transition-colors bg-muted/10">
