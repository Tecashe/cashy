...
//   { value: "dm", label: "Direct Messages (DM)" },
//   { value: "comment", label: "Comments" },
//   { value: "both", label: "Both DMs and Comments" },
// ] as const
...
export const AI_TONES = [
  {
    value: "professional",
    label: "Professional",
    description: "Clear, polite, and business-appropriate tone",
  },
  {
    value: "friendly",
    label: "Friendly",
  ...
  },
  {
    value: "enthusiastic",
    label: "Enthusiastic",
    description: "Energetic and positive, shows excitement",
  },
  {
    value: "helpful",
    label: "Helpful",
    description: "Focused on solving problems and providing support",
  },
  {
    value: "formal",
    label: "Formal",
    description: "Structured and official communication style",
  },
] as const
